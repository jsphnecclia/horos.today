...
class RuephBase
  ...
  # Basic Setup
  attach_function :get_library_path, :swe_get_library_path, [:cstring], :cstring
  # CALL SET_EPHE_PATH (Even with NULL)
  # to initialize important functions
  # TODO: Add set path to class instance
  ...
  attach_function :version, :swe_version, [:string], :string
  ...
  # 13 (or 37) doubles, array for 10 doublesa
  # (37 when int hsys = G)
